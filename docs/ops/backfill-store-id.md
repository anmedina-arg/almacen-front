...
| 2026-08-10 | producción | Corrida única, sin reintentos: `stores` con 1 fila (`market-del-cevil`, id `1`) y las 13 tablas en `0` desde el primer intento — la anomalía de `product_price_history` en test no se repitió acá. |
